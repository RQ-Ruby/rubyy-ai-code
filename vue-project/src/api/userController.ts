...
/** 此处后端没有提供注释 GET /user/isLogin */
export async function isLogin(options?: { [key: string]: any }) {
  return request<API.BaseResponseLoginUserVO>('/user/isLogin', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function register(body: API.registerrRequest, options?: { [key: string]: any }) {
